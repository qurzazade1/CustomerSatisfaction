 ...
 * @author Sadig
 */
public class complain_insert extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
      ...
      String complain__type = (String) request.getParameter("complaintype");

        String company__name = (String) request.getParameter("companyname");
        String text_area = (String) request.getParameter("textarea");

   
   
  String sql = "insert into Customer_Complain (userid,company_name,complain_type,textarea) values(?,?,?,?)";
 ...
 con = dbConnection.dbConnect();
            ...
            preparedStatement.setString(2, company__name);
          preparedStatement.setString(3,complain__type);
